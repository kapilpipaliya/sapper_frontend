...
<head>
  ...
  {#if Setting.demo_projects_available }<meta name="demo_projects_available" content="true"/>{/each}
  {#if Setting.boards_demo_data_available }<meta name="boards_demo_data_available" content="true"/>{/each}
  { csrf_meta_tags %>

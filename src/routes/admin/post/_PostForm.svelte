...
<script>
  ...
  import { sfx, all, ins_, upd_, del, makeObject, nullFirstarrayFix } from "../../_modules/functions.js";
  ...
  async function save() { isSaving = true; S.trigger([[ save_("post", rowIdx), [form, [form.id]] ]]); }
